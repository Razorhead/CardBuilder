...
export var CanvasTextWrapper = function(canvas,text,options) {
    ...
    for (var property in defaults) {
        ...
        EL_WIDTH = options.width;
    EL_HEIGHT = options.height;
...
CanvasTextWrapper.prototype = {
    ...
    _drawText: function() {
        for (var i = 0; i < this.lines.length; i++) {
            ...
            this.context.fillText(this.lines[i],this.left + this.textPos.x,this.top + this.textPos.y);
